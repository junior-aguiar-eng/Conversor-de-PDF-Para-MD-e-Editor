...
O instalador cria um ambiente Python 3.13 isolado em `D:\PDF para Markdown\.venv` e instala o PyMuPDF4LLM. Não há download de modelos de IA, Docker, PyTorch ou uso de GPU.
